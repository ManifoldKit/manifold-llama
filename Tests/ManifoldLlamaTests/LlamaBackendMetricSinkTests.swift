...
final class LlamaBackendMetricSinkTests: XCTestCase {
    ...
    func test_emitMetric_nilSink_dispatchesNothing() {
        ...
        LlamaMetricTracker.emitMetric(from: tracker, to: nil, provider: "llama", model: "m", promptTokens: 0)
    }
    ...
    func test_emitMetric_errorClassPropagates() async {
        ...
        LlamaMetricTracker.emitMetric(from: tracker, to: sink, provider: "llama", model: "m", promptTokens: 5)
