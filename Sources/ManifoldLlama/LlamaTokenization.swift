...
@_spi(Testing) public enum LlamaTokenization {
  ...
  public static func tokenize(
    ...
    let count = llama_tokenize(
      vocab, text, Int32(text.utf8.count), &tokens, maxTokens, addBos, parseSpecial)
  ...
  static func tokenToString(
    _ token: llama_token, vocab: OpaquePointer?, invalidUTF8Buffer: inout [CChar]
  ) -> String? {
